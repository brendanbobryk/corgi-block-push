...
const LEVELS = [
...

  {
    ...
    grid: [
      ...
      [ WALL(), WALL(), WALL(), WALL(), WALL(), WALL(), WALL() ],
      [ WALL(), WALL(), EMPTY(), TREAT(), EMPTY(), WALL(), WALL() ],
      [ WALL(), CORGI(), EMPTY(), POOP(), EMPTY(), GOAL(), WALL() ],
      [ WALL(), WALL(), WALL(), WALL(), WALL(), WALL(), WALL() ],
      [ WALL(), WALL(), WALL(), WALL(), WALL(), WALL(), WALL() ],
...

  {
    ...
    grid: [
      ...
      [ WALL(), CORGI(), BLOCK(), TREAT(), BLOCK(), GOAL(), WALL() ],
...

  {
    ...
    grid: [
      ...
      [ WALL(), EMPTY(), BLOCK(), POOP(), BLOCK(), EMPTY(), WALL() ],
...

  {
    ...
    grid: [
      ...
      [ WALL(), POOP(), EMPTY(), EMPTY(), EMPTY(), EMPTY(), WALL() ],
      [ WALL(), WALL(), BLOCK(), WALL(), WALL(), EMPTY(), WALL() ],
...

  {
    ...
    grid: [
      ...
      [ WALL(), POOP(), EMPTY(), WALL(), EMPTY(), GOAL(), WALL() ],
      [ WALL(), BLOCK(), EMPTY(), WALL(), EMPTY(), POOP(), WALL() ],
      [ WALL(), EMPTY(), BLOCK(), EMPTY(), BLOCK(), EMPTY(), WALL() ],
      [ WALL(), WALL(), EMPTY(), WALL(), EMPTY(), WALL(), WALL() ],
      [ WALL(), TREAT(), EMPTY(), CORGI(), EMPTY(), EMPTY(), WALL() ],
